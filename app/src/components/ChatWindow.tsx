...
const getInitialPosition = () => {
  const availableHeight = window.innerHeight - LAYOUT_CONSTANTS.APPBAR_HEIGHT - LAYOUT_CONSTANTS.PROGRESSBAR_HEIGHT;
  return {
    x: Math.max(CHAT_PADDING, window.innerWidth - CHAT_WIDTH - CHAT_PADDING),
    y: Math.max(
      LAYOUT_CONSTANTS.APPBAR_HEIGHT + CHAT_PADDING,
      LAYOUT_CONSTANTS.APPBAR_HEIGHT + availableHeight - CHAT_HEIGHT - CHAT_PADDING
    ),
  };
};
...
const clampPosition = (x: number, y: number, width: number, height: number) => {
  ...
  const maxY = Math.max(minY, window.innerHeight - LAYOUT_CONSTANTS.PROGRESSBAR_HEIGHT - height - CHAT_PADDING);
    ...
    >
      ...
      >
        ...
        >
          ...
          <Box>
            <IconButton onClick={() => setIsFullscreen(true)} size="small" title="Fullscreen">
              <FullscreenIcon />
            </IconButton>
            <IconButton onClick={onClose} size="small">
              <CloseIcon />
