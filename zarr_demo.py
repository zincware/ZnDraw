...
def get_frame(frame_id):
    try:
        ...
        return Response(np.array(frame_data).tobytes(), mimetype="application/octet-stream")

    except KeyError:
        return Response("Error: 'positions' dataset not found in Zarr store.", status=500)
