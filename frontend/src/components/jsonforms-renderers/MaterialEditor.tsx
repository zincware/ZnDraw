...
import type { MaterialData, MaterialProp } from "../three/materials";
 ...
 */
function isMaterialObject(
	value: MaterialProp | undefined,
): value is MaterialData {
	return (
		typeof value === "object" && value !== null && "material_type" in value
	);
}
...
export const materialEditorTester = rankWith(
	...
	and(
		schemaMatches(
			(schema) => (schema as any)["x-custom-type"] === "three-material",
		),
		uiTypeIs("Control"),
	),
);
